...
class AlbumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create album" do
    assert_difference('Album.count') do
      post albums_url, params: { album: { caption: @album.caption, picture: @album.picture } }
    end
  ...
  test "should update album" do
    patch album_url(@album), params: { album: { caption: @album.caption, picture: @album.picture } }
